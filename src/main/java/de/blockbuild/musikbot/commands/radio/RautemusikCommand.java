...
public class RautemusikCommand extends RadioCommand {
	...
	@Override
	protected void doPrivateCommand(final CommandEvent event) {
		event.reply(event.getClient().getError() + " This command cannot be used in Direct messages.");

		final StringBuilder builder = new StringBuilder().append(event.getClient().getSuccess());
